...
public class BladeModule extends ItemModuleMajor<WeaponModuleData> {
    ...
    public BladeModule(String slotKey) {
    	...
    	data = new WeaponModuleData[] {
            new WeaponModuleData("basic_blade/oak", "minecraft:planks", 100, -1, 1, 0x866526, 0, 0),
            ...
            new WeaponModuleData("basic_blade/gold", "minecraft:gold_ingot", 30, 1, 4, 0xeaee57, 0, 0),
            new WeaponModuleData("basic_blade/diamond", "minecraft:diamond", 540, 0, 5, 0x33ebcb, 0, 0)
	    };
