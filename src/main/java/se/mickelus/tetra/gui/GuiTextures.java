...
public class GuiTextures {
    ...
    public static final ResourceLocation holo = new ResourceLocation(TetraMod.MOD_ID, "textures/gui/holo.png");
    public static final ResourceLocation toolActions = new ResourceLocation(TetraMod.MOD_ID, "textures/gui/tool-actions.png");
