...
public class StatSorters {
    ...
    public static final List<IStatSorter> sorters = new ArrayList<>(Arrays.asList(
            ...
            new BasicStatSorter(new StatGetterToolLevel(ToolAction.AXE), "tetra.tool.axe", StatFormat.noDecimal).setSuffix("tetra.stats.level_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolAction.PICKAXE), "tetra.tool.pickaxe", StatFormat.noDecimal).setSuffix("tetra.stats.level_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolAction.SHOVEL), "tetra.tool.shovel", StatFormat.noDecimal).setSuffix("tetra.stats.level_suffix"),
            ...
            new BasicStatSorter(new StatGetterToolLevel(ToolAction.HOE), "tetra.tool.hoe", StatFormat.noDecimal).setSuffix("tetra.stats.level_suffix"),
            ...
            new BasicStatSorter(new StatGetterToolEfficiency(ToolAction.AXE), "tetra.tool.axe", StatFormat.noDecimal).setSuffix("tetra.stats.efficiency_suffix"),
            new BasicStatSorter(new StatGetterToolEfficiency(ToolAction.PICKAXE), "tetra.tool.pickaxe", StatFormat.noDecimal).setSuffix("tetra.stats.efficiency_suffix"),
            new BasicStatSorter(new StatGetterToolEfficiency(ToolAction.SHOVEL), "tetra.tool.shovel", StatFormat.noDecimal).setSuffix("tetra.stats.efficiency_suffix"),
            ...
            new BasicStatSorter(new StatGetterToolEfficiency(ToolAction.HOE), "tetra.tool.hoe", StatFormat.noDecimal).setSuffix("tetra.stats.efficiency_suffix")
    ));
}
