...
public class StatSorters {
    ...
    public static final List<IStatSorter> sorters = new ArrayList<>(Arrays.asList(
            ...
            new BasicStatSorter(new StatGetterToolLevel(ToolTypes.hammer), "tetra.tool.hammer", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolType.AXE), "tetra.tool.axe", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolType.PICKAXE), "tetra.tool.pickaxe", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolType.SHOVEL), "tetra.tool.shovel", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolTypes.cut), "tetra.tool.cut", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolTypes.pry), "tetra.tool.pry", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
            new BasicStatSorter(new StatGetterToolLevel(ToolType.HOE), "tetra.tool.hoe", StatFormat.noDecimal).setSuffix("tetra.stats.tier_suffix"),
