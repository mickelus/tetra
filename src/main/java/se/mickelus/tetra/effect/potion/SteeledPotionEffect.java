...
public class SteeledPotionEffect extends Effect {
    ...
    public SteeledPotionEffect() {
        ...
        addAttributesModifier(Attributes.ARMOR, "62eba42f-3fe5-436c-812d-2f5ef72bc55f", 1, AttributeModifier.Operation.ADDITION);
    ...
    public void renderInventoryEffect(EffectInstance effect, DisplayEffectsScreen<?> gui, MatrixStack mStack, int x, int y, float z) {
        ...
        EffectHelper.renderInventoryEffectTooltip(gui, mStack, x, y, () ->
                new StringTextComponent(I18n.format("effect.tetra.steeled.tooltip", amount)));
    }
}
